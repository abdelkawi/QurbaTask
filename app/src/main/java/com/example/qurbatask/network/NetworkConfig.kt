...
object NetworkConfig {
    private fun authInterceptor(): Interceptor {
        return object : Interceptor {
            override fun intercept(chain: Interceptor.Chain): Response {
                ...
                request =
                    if (request.header(REQUIRE_AUTHENTICATION_HEADER) != null ) {
                        request.newBuilder()
                            .removeHeader(REQUIRE_AUTHENTICATION_HEADER)
    ...
    private fun buildClient(isDebug: Boolean,authToken: String): OkHttpClient {
